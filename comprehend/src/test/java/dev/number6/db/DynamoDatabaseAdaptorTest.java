...
class DynamoDatabaseAdaptorTest {
    ...
    private DynamoFullDatabaseAdaptor testee;
    ...
    void setup() {
        ...
        testee = new DynamoFullDatabaseAdaptor(mapper, dbConfig);
    }
    ...
    void saveEntityResults() {
        ...
        Map<String, Map<String, Long>> detectEntitiesResults = RDG.map(RDG.string(), RDG.map(RDG.string(20), RDG.longVal(Range.closed(1L, 10L)))).next();
